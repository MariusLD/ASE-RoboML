 ...
 * </p>
 * <ul>
 *   <li>{@link robot.impl.BlockImpl#getInstruction <em>Instruction</em>}</li>
 *   <li>{@link robot.impl.BlockImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BlockImpl extends InstructionImpl implements Block {
	...
	protected EClass eStaticClass() {
		return RobotPackage.Literals.BLOCK;
	}
	...
	public EList<Instruction> getInstruction() {
		if (instruction == null) {
			instruction = new EObjectContainmentEList<Instruction>(Instruction.class, this,
					RobotPackage.BLOCK__INSTRUCTION);
		}
		return instruction;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotPackage.BLOCK__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotPackage.BLOCK__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotPackage.BLOCK__EXPRESSION, newExpression,
					newExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotPackage.BLOCK__INSTRUCTION:
			return ((InternalEList<?>) getInstruction()).basicRemove(otherEnd, msgs);
		case RobotPackage.BLOCK__EXPRESSION:
