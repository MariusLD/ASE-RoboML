	...
	public NotificationChain basicSetCall(Call newCall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotPackage.PRIMARY_EXPR_BOOL__CALL, oldCall, newCall);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCall != call) {
			...
			if (call != null)
				msgs = ((InternalEObject) call).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotPackage.PRIMARY_EXPR_BOOL__CALL, null, msgs);
			if (newCall != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotPackage.PRIMARY_EXPR_BOOL__CALL, newCall,
					newCall));
	}
